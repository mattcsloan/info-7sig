<?php
	function load_theme_styles() {
	    wp_enqueue_style( '7sig-style', get_template_directory_uri() . '/style.css', array(), wp_get_theme()->get('Version') );
	    wp_enqueue_style( '7sig-responsive',
	    ...
	    wp_enqueue_style( 'icomoon',
	        ...
	        array( '7sig-style', '7sig-responsive'),
	        '1.0.0'
	    );
	}
